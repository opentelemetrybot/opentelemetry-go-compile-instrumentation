module go.opentelemetry.io/otelc/test/apps/gincustom

go 1.25.0

replace (
	go.opentelemetry.io/otelc/instrumentation => ../../../instrumentation
	go.opentelemetry.io/otelc/instrumentation/go.opentelemetry.io/otel/init => ../../../instrumentation/go.opentelemetry.io/otel/init
	...
	go.opentelemetry.io/otelc/test/apps/gincustom/instrumentation => ./instrumentation
)

require (
	github.com/gin-gonic/gin v1.10.0
	go.opentelemetry.io/otelc/instrumentation/go.opentelemetry.io/otel/init v0.0.0-00010101000000-000000000000
	go.opentelemetry.io/otelc/test/apps/gincustom/instrumentation v0.0.0-00010101000000-000000000000
)
...
require (
	...
	go.opentelemetry.io/otelc/instrumentation/net/http/server v0.0.0-00010101000000-000000000000 // indirect
